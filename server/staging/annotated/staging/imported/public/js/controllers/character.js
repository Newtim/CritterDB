...
creatureCtrl.$inject = ["$scope", "creature", "Creature", "$routeParams", "Skills", "$location", "CreatureData", "$mdMedia", "$mdDialog", "CreatureAPI", "ChallengeRatingCalculator", "TextUtils", "Auth", "CreatureClipboard"];
