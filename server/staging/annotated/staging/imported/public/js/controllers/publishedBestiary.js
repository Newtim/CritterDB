...
publishedSkillsCtrl.$inject = ["$scope", "Skills", "bestiaries", "owner", "$routeParams", "PublishedSkills", "PublishedSkillsCreaturePager", "PublishedSkillsPager", "UserPublishedSkillsPager", "SearchPublishedSkillsPager", "CreatureFilter", "CreatureAPI", "CreatureClipboard", "$mdMedia", "$mdDialog", "Auth", "$location", "Skills", "Creature", "$window", "Mongo"];
