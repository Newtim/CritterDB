angular.module('myApp').factory("ChallengeRatingCalculator", ["$mdMedia", "$mdDialog", function($mdMedia,$mdDialog) {
	...
	calculateChallengeRatingCtrl.$inject = ["$scope", "creature", "$mdDialog", "CreatureData"];
