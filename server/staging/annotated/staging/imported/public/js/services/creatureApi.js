angular.module('myApp').factory("CreatureAPI", ["$location", "CreatureClipboard", "Creature", "$mdMedia", "$mdDialog", function($location,CreatureClipboard,Creature,$mdMedia,$mdDialog) {
